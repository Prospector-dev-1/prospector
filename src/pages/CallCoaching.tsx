                ...
                {coachingData.tips && coachingData.tips.length > 0 ? (
                  <Card>
                    <CardHeader className="pb-3 sm:pb-6">
                      ...
                      <CardDescription className="text-sm">
                        Bite-sized insights to improve your performance
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="pt-0">
                      <div className="grid gap-3 sm:gap-4">
                        {coachingData.tips.map((tip, idx) => (
                          <Alert key={idx}>
                            <Lightbulb className="h-4 w-4" />
                            <AlertTitle className="text-sm sm:text-base">Tip #{idx + 1}</AlertTitle>
                            <AlertDescription className="mt-2 text-sm sm:text-base leading-relaxed">
                              {tip}
                            </AlertDescription>
                          </Alert>
                        ))}
                  ...
                  <Card>
                    <CardContent className="text-center py-6 sm:py-8">
                      ...
                      <p className="text-muted-foreground text-sm sm:text-base">No tips available</p>
                    </CardContent>
                  </Card>
                )}
              </TabsContent>
