...
const ConversationPanel: React.FC<ConversationPanelProps> = ({
  ...
  const { isActive, isConnecting, exchangeCount, currentScore } = conversationState;
        ...
        <CardContent>
          <div className="text-center py-8">
            ...
            <p className="text-muted-foreground">
              Select a moment from the timeline to start an AI conversation
            </p>
          </div>
        </CardContent>
      </Card>
